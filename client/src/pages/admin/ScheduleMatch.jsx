        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit"
              ...
              className={`w-full py-2.5 rounded-lg font-medium text-sm transition-colors flex items-center justify-center gap-2 ${loading || !formData.teamA || !formData.teamB || formData.teamA === formData.teamB
