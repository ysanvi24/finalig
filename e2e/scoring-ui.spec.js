...
test.describe('📱 Scoring UI Validation', () => {
    ...
    test('Official scoring table shows events and filters', async ({ page }) => {
        ...
        const p1Header = page.getByText('P1').first();
    ...
    test('Events page has rank assignment buttons', async ({ page }) => {
        ...
        // Depending on seeded data, group events may be empty in some envs.
        // Validate page stability and actionable controls when available.
